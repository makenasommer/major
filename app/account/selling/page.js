...
export default function SellerDashboardPage() {
  ...
  // PLACEHOLDER — showing all mock listings as a stand-in for "your" listings
  // until listings are actually tied to the logged-in seller's account.
  const yourListings = MOCK_LISTINGS;
